            ...
            steps {
                script {
                    if (fileExists('Dockerfile')) {
                        ...
                        dockerfileContent = dockerfileContent.replaceAll(/ENV DATABASE_URI .*/, "ENV DATABASE_URI mongodb://parse-stack_mongo:27017")
                        ...
                        ENV DATABASE_URI=mongodb://parse-stack_mongo:27017
